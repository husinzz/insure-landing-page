...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile */}
      <nav className="font-karla fixed top-0 max-h-[63px] z-20 w-full bg-white p-3 lg:hidden">
        ...
        <div
          ...
          <div
            ...
            <div className=" flex flex-col items-center">
              ...
              <button className="font-karla border-2 border-white mt-3 w-4/5 py-2 font-bold">
                VIEW PLANS
              </button>
            </div>
            <img className="absolute bottom-0 w-full" src="/bg/bg-pattern-mobile-nav.svg" />
          </div>
        </div>
      </nav>
    </>
